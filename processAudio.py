...
def processAudio(s, drawer, q, audioPath, scorePath,lastNote, lastDuration,detected,noteDetected, flute):
    ...
    print("isSound: {}".format(soundBool))
    if soundBool:
        ONSET_PARAM = 1
        ...
        print("------------------")
        print("onset_times: {}".format(onset_times))
        print("------------------")
        print("------------------")
            ...
            if detected == 'note':
                ...
                if j < length-1:
                    ...
                    if chord != '' :
                        ...
                        m21Chord = c21.Chord(getNotesFromChords(getBaseNote(nota),4))
                        m21Chord.duration = d21.Duration(getFigureDuration(figure))
                        print("saving chord {}".format(chord))
                        s.append(m21Chord)
                        nota = chord
                elif j == length-1:
