...
def getNotesFromChords(chord,signal,sr):
    notas_string = ['A','A#','B','C','C#','D','D#','E','F','F#','G','G#']	
    nota_2 =''
    nota_3 =''
    octaveIndex = 2
    secondNoteIndex = 3
   ...
   # octava = int(chord[octaveIndex])
    ...
    if ((indice + secondNoteIndex) / 12) >= 1 :
        ...
        nota_2 = notas_string[((indice + secondNoteIndex )%12)] + str(int(chord[octaveIndex] + 1))
    else:
        nota_2 = notas_string[(indice + secondNoteIndex)]  +  str(int(chord[octaveIndex]))
    if ((indice + 7) / 12) >= 1 :
        nota_3 = notas_string[((indice + 7) %12)] +  str(int(chord[octaveIndex] + 1))
    else:
        nota_3 = notas_string[(indice + 7)]  +  str(int(chord[octaveIndex]))
