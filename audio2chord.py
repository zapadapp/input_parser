...
#Categories from version 03
CATEGORIES = ["A","B","C","D","E","F","G","A","A#",
              "A-","B","B-","C","C#","C-","D","D#",
              "D-","E","E-","F","F#","F-","G","G#","G-"]
INSTRUMENT = ["Guitar","Piano"]
chord_model = keras.models.load_model('../chord_cnn/modelo-acordes-v03.h5')
...
def detectAndPrintChord(s, q, y, sr, samples, a, b, scorePath):
    ...
    if is_sound:
        ...
        showLog(playedIntrument,playedChord,triada)
    return    

def showLog(playedIntrument,playedChord,triada):
